    ...
    data: [
      {
        ...
        image_urls: ["chene-pedoncule.jpg"],
        stock: 100,
      ...
      // 🌱 NOUVEAUX (6)
      {
        ...
        image_urls: ["erable-sycomore.jpg"],
        stock: 85,
