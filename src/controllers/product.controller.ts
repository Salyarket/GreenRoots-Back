...
import { productDbSchema, 
  productSchemaForCreate,  
  productSchemaForUpdate} 
  from "../schemas/product.schema.js";
import { ImgCreatePath, 
  ImgUpdatePath, 
  deleteFiles} 
  from "../utils/imgUpload.js";
import { TextToSlugCreate, 
  TextToSlugUpdate
} from "../utils/TextToSlug.js";
...
class ProductController extends BaseController {
  ...
  createProduct = async (req: any, res: any) => {
    ...
    try {
      ...
      const imgPath = ImgCreatePath(dataWithSlug, req.files as Express.Multer.File[]);
  ...
  updateProduct = async (req: any, res: any) => {
    try {
      ...
      const dataWithImg = ImgUpdatePath(existingProduct , dataWithSlug, req.files as Express.Multer.File[]);
    ...
    try {
      ...
      if (product.image_urls?.length) {
        try {
          ...
          console.error("impossible de supprimer le ou les fichiers:", fileError);
